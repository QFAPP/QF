    ...
    def extract(self):
        ...
        while True:
            ...
            for topic_entry in topic_entries:
                ...
                retrieved_articles = self.source_plugin.retrieve_articles(topic_entry)
                while True:
                    ...
                    # Store the results
                    self.destination_plugin.store(topic_entry_name, articles_entries)

                    # Retrieve the next page
                    articles_next_page_url = self.source_plugin.next_page(articles_meta)
                    ...
                    retrieved_articles = self.source_plugin.retrieve_items(articles_next_page_url)
            ...
            retrieved_topics = self.source_plugin.retrieve_items(topics_next_page_url)